...
let inventorNames = inventors.map((inventor) => {
  //access to all of this object elements
...
// const yearsArr = inventors.map((inventor) => {
//   return inventor.passed - inventor.year;
// });

// let totalYearsLived = yearsArr.reduce((total, num) => total + num);
...
let travelMethodCounts = travelMethods.reduce((total, travelMethod) => {
